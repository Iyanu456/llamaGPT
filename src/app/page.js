...
export default function Home() {
  return (
    <div className="relative main-container w-[100%] h-screen">
        <aside></aside>
        <main>
            <header className="max-sm:left-0 sticky top-0 right-0 left-[16em] bottom-[auto] px-3 py-[1.4em] grid place-items-center">
                <div>App Logo</div>
            </header>
            <div class="h-[80%] px-2 py-[3em] chat-container">example</div>
